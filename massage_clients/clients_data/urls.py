...
urlpatterns = [
    path('', views.CreateClient.as_view(), name='client_form'),  # URL for the first page with the form to fill
    path('client-list/', views.AllClients.as_view(), name='client_list'),  # URL for the second page with the actual clients list
    path('clients/<int:pk>/<str:name>/', views.SingleClient.as_view(), name='single_client'),
